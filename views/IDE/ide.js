    ...
    var sendRequest = function (data) {
        ...
        $.ajax({
            ...
            "headers": {
                ...
                "Content-Type": "application/json",
                "X-RapidAPI-Key": "01f4795cd1msh4068645813da278p1b04b9jsnb16964676c95",
...
function fetchSubmission(submission_token) {
    var ur=`https://ce.judge0.com/submissions/${submission_token}?base64_encoded=true&fields=stdout,stderr,status_id,language_id`;
    console.log("=========",ur);
    $.ajax({
        ...
        async: true,
        success: function (data, textStatus, jqXHR) {
            console.log("dataaaa11",data);

            if (data.language_id <= 2) { // In Queue or Processing
...
function resolveApiUrl(id) {
    id = parseInt(id);
    return languageApiUrlTable[id] || defaultUrl;apiUrl + "/submissions/"
